...
**您当前访问的是 `myself` 分支，该分支的代码为本人手工编写，将用于课程设计考核。代码文件位于`/src`目录下。**

本课设共包含两个分支：

- **`myself` 分支**：手工 coding，**考核主体**。
- **`main` 分支**：其中的 `blockyProg` 库有大部分业务代码由 AI 生成。该分支仅用于验证自制库的通用性与完善性（证明 AI 能够掌握并运用该库），**并非为课程设计考核而设**。
...
![main分支主机展示](./doc/myself分支主机展示.jpg)
## 需求分析
